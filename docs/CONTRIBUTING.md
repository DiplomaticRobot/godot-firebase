# <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="28"> Contributing

Thank you for your interest in contributing to the Godot GodotFirebase Plugin! This guide will help you understand the project structure, build processes, and development workflows.

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Table of Contents
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Project structure
...
│   ├── godot_firebase_plugin.xcodeproj/     # Xcode project
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Prerequisites
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Common Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Gradle Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Android SDK Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> iOS Configuration
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Development Workflow

### Initial Setup

1. **Clone the repository:**
   ```bash
   git clone https://github.com/godot-mobile-plugins/godot-godot-firebase.git
   cd godot-godot-firebase
   ```
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Building

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Android Builds
...
- **Release archive:** `common/build/archive/GodotFirebasePlugin-Android-v*.zip`

---

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> iOS Builds
...
- **Release archive:** `ios/build/release/GodotFirebasePlugin-iOS-v*.zip`
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Cross-Platform Builds
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Testing
...
# View logs
adb logcat | grep -i GodotFirebase
```
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Creating Releases
...
This creates:
- `release/GodotFirebasePlugin-Android-v*.zip`
- `release/GodotFirebasePlugin-iOS-v*.zip`
- `release/GodotFirebasePlugin-Multi-v*.zip` (combined)
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Installation

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Installing to Demo App
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="20"> Installing to Your Project

```bash
# Using install script
./script/install.sh -t /path/to/your/project -z /path/to/GodotFirebasePlugin-*.zip

# Example
./script/install.sh -t ~/MyGame -z release/GodotFirebasePlugin-Multi-v6.0.zip
```

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Troubleshooting
...
- Check existing [GitHub Issues](https://github.com/godot-mobile-plugins/godot-godot-firebase/issues)
- Check exısting [GitHub Discussions](https://github.com/godot-mobile-plugins/godot-godot-firebase/discussions)
- Review [Godot documentation](https://docs.godotengine.org/)

---

## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Contributing Guidelines
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-godot-firebase/main/addon/src/icon.png" width="24"> Additional Resources
